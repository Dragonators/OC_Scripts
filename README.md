...
OpenOS `/home`. Version 9 replaces the v8 runtime instead of loading any of its
shared modules. Existing v9 `fog_quark.cfg` and `fog_magmatter.cfg` files are
preserved; incompatible v8 configuration is deliberately not migrated. All hint
items and fluids are returned to the main AE network through the dual ME interface.
